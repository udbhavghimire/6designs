        ...
        <span class="fs-4 d-flex justify-content-center text-center px-1">Trusted by 300+ amazing clients across Greater Toronto Area</span>
            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-3 justify-content-center g-4 mt-2 px-2">
                ...
                <div class="col">
                    ...
                    <div class ="img-text"><p class="img-text">Joy Towns </p></div>
                    </a>
                </div>
                <div class="col">
                ...
                <div class="col">
                    ...
                    <div class ="img-text"><p class="img-text">Bodhi Townhomes</p></div>
                    </a>
                </div>
                <div class="col">
                    ...
                    <div class ="img-text"><p class="img-text">DUO Condos</p></div>
                    </a>
                </div>
                <div class="col">
                    ...
                    <div class ="img-text"><p class="img-text">Honeystone Homes</p></div>
                    </a>
                </div>
